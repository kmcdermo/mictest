...
do
    ...
    ./mkFit/mkFit --read --file-name ${dir}/cmssw_100xTTbarPU35_polar_split_mock_noFWD.bin --cms-geom --cmssw-seeds --build-bh   --num-thr 12 >& log_snb_100xTTbarPU35_BH_NVU${nvu}_NTH12.txt
    echo "snb cmssw" nvu=${nvu} "COMB (barrel)"
    ./mkFit/mkFit --read --file-name ${dir}/cmssw_100xTTbarPU35_polar_split_mock_noFWD.bin --cms-geom --cmssw-seeds --build-comb --num-thr 12 --cloner-single-thread >& log_snb_100xTTbarPU35_COMB_NVU${nvu}_NTH12.txt
