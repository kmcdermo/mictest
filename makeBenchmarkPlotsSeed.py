...
g = ROOT.TFile('benchmark_seeding.root',"recreate")
...
for test in ['triplets','merge','seeding','fit','full']:
    for tracks in ['1000','5000','10000']:
        ...
        for vu in vuvals:
            ...
            with open('seedingtimes_nTH'+nth+'_nVU'+vu+'_nTk'+tracks+'.txt') as f:
                for line in f:
                    lsplit = line.split(',')
                    if not firstFound:
                        firstFound = True
...
for test in ['triplets','merge','seeding','fit','full']:
    for tracks in ['1000','5000','10000']:
        ...
        for th in thvals:
            ...
            # Read in times from log files, store into yvals
            with open('seedingtimes_nTH'+th+'_nVU'+nvu+'_nTk'+tracks+'.txt') as f:
                for line in f:
                    lsplit = line.split(',')
                    if not firstFound:
                        firstFound = True
