...
do
    ...
    ./mkFit/mkFit --read --file-name ${dir}/simtracks_barrel_20x10k.bin --build-bh   --num-thr 12 >& log_snb_20x10k_BH_NVU${nvu}_NTH12.txt
    echo "snb toymc" nvu=${nvu} "COMB (barrel)"
    ./mkFit/mkFit --read --file-name ${dir}/simtracks_barrel_20x10k.bin --build-comb --num-thr 12 --cloner-single-thread >& log_snb_20x10k_COMB_NVU${nvu}_NTH12.txt
