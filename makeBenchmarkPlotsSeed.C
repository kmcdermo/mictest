...
void makeBenchmarkPlotsSeed(bool isKNC = false)
{
  ...
  tests.push_back("triplets"); 
  tests.push_back("merge");
  tests.push_back("seeding");
  ...
  stests.push_back("Triplet Finding Only");
  stests.push_back("Triplets to Tracks Only");
  stests.push_back("Seeding Only");
